...
* [结构型模式](structural_patterns/structural.md)
   * [适配器模式](structural_patterns/adapter.md)
   * [桥接模式](structural_patterns/bridge.md)
   * [装饰模式](structural_patterns/decorator.md)
   * [外观模式](structural_patterns/facade.md)
...
* [行为型模式](behavioral_patterns/behavioral.md)
   ...
   * [观察者模式](behavioral_patterns/observer.md)
   * [状态模式()](behavioral_patterns/state.md)
